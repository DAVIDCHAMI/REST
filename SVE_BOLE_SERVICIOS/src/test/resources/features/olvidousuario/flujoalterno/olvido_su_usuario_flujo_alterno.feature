Feature:
  ...
  """
    ...
    * def jsonRequetsPost = read('../../../jsons/olvidosuusuario/validacionusuario/ValidarUsuarioAlternoPost.json')
    Given url (urlPath)
    ...
    * def responseNickName = response
    Then match responseNickName.header.errorCode == 'ERR00000'

  @FlujoCompaniaIncorrecta
  Scenario: olvido su usuario flujo alterno
    * def jsonParametroGetParams =
    """
  {
  ...
  """
    ...
    * def jsonRequetsPost = read('../../../jsons/olvidosuusuario/validacionusuario/ValidarUsuarioPost.json')
    ...
    And request jsonRequetsPost
    When method POST
    * def jsonRequetsPost = read('../../../jsons/olvidosuusuario/validacioncompañia/ValidarCompaniaAlternoPost.json')
    Given url (urlPath)
    And path 'company/remember/info'
    And header CORRELATIONID = '73284923'
    And header SESSIONID = responseGetParams.response.header.sessionId
