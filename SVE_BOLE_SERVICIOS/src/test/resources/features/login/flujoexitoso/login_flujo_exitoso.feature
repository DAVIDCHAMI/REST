Feature: Como empresa afiliada en la sve deseo poder iniciar sesion en la aplicacion
  ...
  Scenario: Autenticacion - Flujo exitoso
    ...
    * def arrayParams = datosGetParams.response.data.extras
    * print arrayParams
    * def salt = Java.type('resources.parseDatos').devolverSALT(arrayParams)
